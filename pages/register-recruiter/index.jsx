...
const RecruiterRegister = () => {
    ...
    async function registerHendler(e) {
        ...
        const registerReq = await fetch(`${process.env.API_BACKEND}auth/register`, {
            method: 'POST',
            ...
            <div className="body">
                ...
                <div className="form">
                        ...
                        <form onSubmit={registerHendler.bind(this)}>
                            <div className="mt-4">
                                <div className="row d-flex justify-content-center align-items-center">
                                    ...
                                    <div className="col-md-12 mb-3">
                                        <div className="form-group text-muted">
                                            <label className="mb-1" htmlFor="company">Perusahaan</label>
                                                <input
                                                    type='text'
                                                    className='form-control'
                                                    id='company'
                                    ...
                                    <div className="col-md-12 mb-3">
                                        <div className="form-group text-muted">
                                            <label className="mb-1" htmlFor="position">Jabatan</label>
                                                <input
                                                    type='text'
                                                    className='form-control'
                                                    id='position'
                        ...
                        <div className="row mt-3">
                            <div className="col-12 d-flex justify-content-center align-items-center">
                                <span className="text-black">Belum punya akun pekerja?</span>
